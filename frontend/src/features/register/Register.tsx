          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="h-24">
              <label className="block">
                <span className="block text-sm text-white text-left mb-1">First Name</span>
                <input
                ...
                <div className="h-5 mt-1">
                  {errors.firstName && <p className="text-sm text-white">{errors.firstName.message}</p>}
                </div>
              </label>
            </div>
            ...
            <div className="h-24">
              <label className="block">
                <span className="block text-sm text-white text-left mb-1">Last Name</span>
                <input
                  className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500"
                  {...register('lastName', {
                ...
                />
                <div className="h-5 mt-1">
                  {errors.lastName && <p className="text-sm text-white">{errors.lastName.message}</p>}
                </div>
              </label>
            </div>
          </div>
